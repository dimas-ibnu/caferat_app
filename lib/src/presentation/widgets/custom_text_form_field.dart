...
import 'package:caferat_app/src/untilities/debouncer.dart';
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          contentPadding: const EdgeInsets.symmetric(horizontal: DoubleConstant.spacing12),
          enabledBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(DoubleConstant.defaultRadius),
